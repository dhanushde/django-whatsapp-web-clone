...
#### Login User1 
* Url: https://demo.dhanush.s/django-whatsapp-clone/admin/login/ (Use Chrome Browser)
* Login: dhanush123
* Pass: dhanush123

#### Login User2 
* Url: https://demo.dhanush.s/django-whatsapp-clone/admin/login/ (Use Microsoft Edge or any browser except Chrome)
* User: kumar123
* Pass: kumar123

#### Start Chat
##### Make sure to login using User1 or User2
https://demo.dhanush.s/django-whatsapp-clone/chat/2/

...
#### Login User1 
* Url: https://demo.dhanush.dk/django-whatsapp-clone/admin/login/ (Use Chrome Browser)
* Login: johnny2020
* Pass: johnny2020

#### Login User2 
* Url: https://demo.dhanush.dk/django-whatsapp-clone/admin/login/ (Use Microsoft Edge or any browser except Chrome)
* User: jay1234
* Pass: jay1234

#### Start Chat
##### Make sure to login using User1 or User2
https://demo.dhanush.dk/django-whatsapp-clone/chat/2/
